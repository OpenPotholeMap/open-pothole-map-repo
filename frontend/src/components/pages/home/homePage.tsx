  ...
  const reimbursementLinks = [
    {
      ...
      description:
        "File a claim with Florida Department of Transportation for vehicle damage caused by potholes on state roads",
    ...
    },
    {
      ...
      description:
        "Download the official claim form for pothole damage reimbursement",
      ...
      <div className="container mx-auto px-4 pt-20 pb-8">
        ...
        <div className="mt-12">
          ...
          <p className="text-muted-foreground mb-8">
            Get compensated for vehicle damage caused by potholes. File claims
            with government agencies or your insurance provider.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                  <li>
                    • Document the pothole with photos and location details
                  </li>
